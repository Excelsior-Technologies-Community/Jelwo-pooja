...
import contactInfoImage from "./assets/contact3.webp";
...
function ContactUs2() {
  ...
  return (
    <main className="page-shell">
      ...
      <section className="contact-two-panel">
        <div className="contact-two-panel__inner">
          <div className="contact-two-panel__media">
            <img src={contactInfoImage} alt="Store locations map" />
          </div>

          <div className="contact-two-panel__content">
            <p className="contact-two-panel__eyebrow">WE'D LOVE TO HEAR FROM YOU</p>
            <h2>Contact us</h2>

            <div className="contact-two-panel__item">
              <div className="contact-two-panel__icon">
                <PhoneIcon />
              </div>
              <div>
                <h3>LET'S TALK</h3>
            ...
            <div className="contact-two-panel__item">
              ...
              <div>
                <h3>STORE ADDRESS</h3>
                <p>27 Eden walk eden centre, Broadway, Paris, France</p>
              </div>
            </div>

            <div className="contact-two-panel__socials">
        ...
        <div className="contact-two-benefits">
          <article className="contact-two-benefits__item">
            <h3>STORE ADDRESS</h3>
            <p>The quickest way to know a woman is to go shopping with her</p>
          </article>
          ...
          <article className="contact-two-benefits__item">
            <h3>24/7 SUPPORT</h3>
            <p>Successful people are always looking for opportunities to help others.</p>
          </article>
        </div>

        <div className="contact-two-map">
          <iframe
      ...
      <section className="contact-form-block contact-form-block--white">
