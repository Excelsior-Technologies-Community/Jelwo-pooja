      ...
      <header className="topbar">
        <div className="topbar__inner">
          ...
          <div className="topbar__actions">
            ...
            <button className="icon-link icon-link--count" type="button" aria-label="Wishlist"><HeartIcon /><span>({wishlistCount})</span></button>
          ...
          <div className="cart-page__content">
            <div className="cart-page__shipping">
              <p>
                {cartSubtotal >= 85
                  ...
                  : `Spend Rs. ${formatAmount(85 - cartSubtotal)} more to get free shipping!`}
              </p>
              <div className="cart-page__shipping-bar" aria-hidden="true">
            ...
            <div className="cart-page__table">
              ...
              <div className="cart-page__items">
                {cartItems.map((item) => {
                  const itemTotal = parsePriceValue(item.price) * item.quantity;
                  const variantLabel = /^\d+$/.test(String(item.variant)) ? "Size" : "Color";

                  return (
                    <article className="cart-page__item" key={`${item.id}-${item.variant}`}>
                      <div className="cart-page__product">
                        ...
                        <div className="cart-page__details">
                          ...
                          <p className="cart-page__variant">
                            {variantLabel}: <span>{item.variant}</span>
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="cart-page__actions">
                        <div className="cart-page__qty">
                          <button
                            ...
                            onClick={() => onUpdateCartQuantity(item.id, item.variant, -1)}
                          >
                            -
                          </button>
                        ...
                        <button
                          ...
                          onClick={() => onRemoveCartItem(item.id, item.variant)}
                        >
                          <i className="fa fa-trash" aria-hidden="true"></i>
                        </button>
                      </div>

                      <p className="cart-page__total">Rs. {formatAmount(itemTotal)}</p>
                    </article>
                  );
                })}
              </div>
            ...
            <div className="cart-page__footer">
              <div className="cart-page__left">
                <div className="cart-page__coupon">
                  ...
                  <button type="button" aria-label="Apply discount code">
              ...
              <div className="cart-page__summary-wrap">
                <button type="button" className="cart-page__return-btn" onClick={navigateToHome}>
                  RETURN TO STORE
                </button>
                ...
                <div className="cart-page__summary">
                  <div className="cart-page__summary-row">
                    ...
                    <span>Rs. {formatAmount(cartSubtotal)}</span>
                  </div>
