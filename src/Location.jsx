...
function ClockIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M12 7.8v4.6l3.2 1.8" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function Location() {
  ...
  return (
    <main className="page-shell">
      ...
      <section className="contact-two-panel location-page__panel location-page__panel--alt">
        <div className="contact-two-panel__inner">
          <div className="contact-two-panel__media">
            <img src={location1} alt="Valsone shop" />
          </div>
      ...
      <section className="contact-two-panel location-page__panel location-page__panel--alt">
        <div className="contact-two-panel__inner">
          ...
          <div className="contact-two-panel__media">
            <img src={location2} alt="Valsone shop" />
          </div>
        </div>
      </section>
      ...
      <section className="contact-two-panel location-page__panel location-page__panel--alt">
        <div className="contact-two-panel__inner">
          <div className="contact-two-panel__media">
            <img src={location3} alt="Valsone shop" />
          </div>
