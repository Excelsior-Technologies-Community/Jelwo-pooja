...
function Refund() {
  ...
  return (
    <main className="page-shell">
      ...
      <section className="refund-policy-layout">
        <div className="refund-policy-layout__column">
          <p>
        ...
        <div className="refund-policy-layout__column">
          <p>
            You can always contact us for any return question at <a href="mailto:support@store.com">support@store.com</a>
          </p>
