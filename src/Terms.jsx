...
function Terms() {
  ...
  return (
    <main className="page-shell">
      ...
      <section className="terms-policy-layout">
        <div className="terms-policy-layout__column">
          <h2>Term &amp; Condition overview</h2>
          <p>
          ...
          <h2>Completeness and timeliness of information</h2>
          <p>
            The Green to Wear 2.0 standard aims to minimize the environmental impact of textile production. To this end, we have developed Inditex's The List program.
          </p>
        ...
        <div className="terms-policy-layout__column">
          <h2>Last updated: March 25, 2023</h2>
          <p>
            The Green to Wear 2.0 standard aims to minimize the environmental impact of textile production. To this end, we have developed Inditex's The List program.
          </p>
